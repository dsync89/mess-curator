...
# ----------------------
# Bandai Super Note Club (moved to all)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Bandai Super Vision 8000 (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Epoch Game Pocket Computer (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Epoch Super Cassette Vision (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# JAKKS Pacific TV Motion Game (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Mattel Electronics Handhelds (LCD) (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Mattel Intellivision ECS (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Milton Bradley Handhelds (LCD) (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Parker Brothers Handhelds (LCD) (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Tandy TRS-80 Color Computer (Moved to All)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Technosys Aamber Pegasus (Moved to all)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Tiger Electronics Handhelds (LCD) (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# Ultimate Products TV Games (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# VideoBrain Family Computer (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
...
# ----------------------
# VTech Genius Leader Color (moved)
# ----------------------
python .\src\mess_curator.py search by-name `
